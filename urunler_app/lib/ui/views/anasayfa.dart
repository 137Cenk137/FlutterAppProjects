            ...
            return ListView.builder(
              ...
              itemBuilder: (context,index){
                ...
                return GestureDetector(
                  onDoubleTap: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context) => DetaySayfa(urun: urun))).then((value) {
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text("${urun.fiyat} TL",style: TextStyle(fontSize: 20,color: Colors.red ),),
                            ),
